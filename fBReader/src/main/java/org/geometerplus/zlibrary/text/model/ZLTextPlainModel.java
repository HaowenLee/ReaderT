            ...
            switch (type) {
                ...
                case ZLTextParagraph.Entry.STYLE_OTHER: {
                    ...
                    if (ZLTextStyleEntry.isFeatureSupported(mask, COLOR)) {
                        final short value1 = (short) data[dataOffset++];
                        final short value2 = (short) data[dataOffset++];
                        final short value3 = (short) data[dataOffset++];
                        char[] color = new char[]{
                                '#',
                                (char) (value1 & 0xFF),
                                (char) ((value1 >> 8) & 0xFF),
                        ...
                        try {
                            entry.setColor(Color.parseColor(s));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
